...
function DetailScores(){
    ...
    return(
        <>
            <div className="score" id={1} onClick={onClick}></div>
            <div className="score" id={2} onClick={onClick}></div>
            <div className="score" id={3} onClick={onClick}></div>
            <div className="score" id={4} onClick={onClick}></div>
            <div className="score" id={5} onClick={onClick}></div>
        </>
    )
}
